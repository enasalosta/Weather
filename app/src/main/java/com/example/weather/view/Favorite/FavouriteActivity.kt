package com.example.weather.view.Favorite
...
class FavouriteActivity : AppCompatActivity() , NavigationView.OnNavigationItemSelectedListener{
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        navigationView.setCheckedItem(R.id.item_fav)

        //button
        var btn: FloatingActionButton = findViewById(R.id.addFavorite)
        btn.setOnClickListener {
            var intent = Intent(this, NewFavorite::class.java)

...
import com.example.weather.view.Favorite.NewFavorite
...
class AlertActivity : AppCompatActivity() , NavigationView.OnNavigationItemSelectedListener{
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        navigationView.setCheckedItem(R.id.item_alert)


        //button
        var btn: FloatingActionButton = findViewById(R.id.addAlert)
        btn.setOnClickListener {
            var intent = Intent(this, New_Alert::class.java)
